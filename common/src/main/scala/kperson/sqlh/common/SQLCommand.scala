...
case class Query(sql: String, params: Map[String, SQLPrimitive] = Map(), transactionReference: TransactionReference = Custom("")) extends SQLCommand
case class Write(sql: String, params: Map[String, SQLPrimitive] = Map(), transactionReference: TransactionReference = Custom("")) extends SQLCommand
